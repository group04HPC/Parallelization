...
int main(int argc, char* argv[]){
    ...
    SubGraph *mergedSub2 = mergeGraphs(mergedSub1, g14, startDim1 - newDim1, startDim14 - g14->nV, result17);
    printf("\nMerged Graph 2:\n");
