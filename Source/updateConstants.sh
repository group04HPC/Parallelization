...
#
# Purpose of the file:
# This file contains the script used to automatically update the constants in the file "Costants.h"

if [ $# -le 2 ]; then
	echo -e "You have to specify the new values!\n Usage:\n\t \"$0 [WORK_LOAD] [MIN_EDGES_PARALLEL] [MAX_EDGES_PARALLEL]\" "
	exit 1
fi
